...
{{ <figure page={page} src="big_pile.jpg" caption="Yes, there is a game about sorting socks." credits="It's called [Sort the Socks](https://apps.apple.com/app/sort-the-socks/id438108346) and you can get it for free on the App Store." /> }}
...
A Computer Scientist might call this pile of socks a _resource_.
You and your friend get bluntly degraded to _workers_.
Both of you can work on the problem at the same time &mdash; or _in parallel_.
...
{{ <figure page={page} src="equation.svg" caption="The formula for the sorting time." /> }}
...
{{ <figure page={page} src="socks_even.svg" caption="Even piles of socks." /> }}

In this case, we have about equally sized piles for each color. Looks
like a fair workload for every worker to me.

{{ <figure page={page} src="socks_uneven.svg" caption="Uneven piles of socks." /> }}
...
For example, we could have _two_ workers sort the big gray pile together. One
...
{{ <figure page={page} src="random_pile.jpg" caption="A random pile of socks." /> }}
...
whole _class_ of problems. We think of the nature of objects and their properties.
